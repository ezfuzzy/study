	...
	function printCode(data){
		...
		$("<script/>").attr("src","https://cdn.jsdelivr.net/gh/google/code-prettify@master/loader/run_prettify.js")
		.appendTo("head");
	}
	...
	$(function(){
		...
		$("#copyBtn").click(function(){
			$("#clipBadge").text("");
			clipCount=0;
			let data=$(".prettyprint").text();
			// 새로운 <textarea> 엘리먼트를 생성하고 변수에 저장된 문자열을 그 안에 설정합니다.
		    var tempTextArea = document.createElement("textarea");
		    tempTextArea.value = data;

		    // <textarea>를 문서에 추가합니다.
		    document.body.appendChild(tempTextArea);

		    // <textarea> 내용을 선택합니다.
		    tempTextArea.select();

		    // <textarea> 내용을 클립보드로 복사합니다.
		    document.execCommand('copy');

		    // 사용이 끝나면 <textarea>를 제거합니다.
		    document.body.removeChild(tempTextArea);

		    // 복사가 완료되면 사용자에게 알릴 수 있습니다.
		    alert("code 가 클립보드로 복사되었습니다");
		});
