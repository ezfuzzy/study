            ...
            <tr key={item.id} className="border-b border-gray-200 hover:bg-gray-100">
              ...
              <td className="py-3 px-6 text-left">
                <div>
                  ...
                  <p><strong>Updated At:</strong> {item.updatedAt ? new Date(item.updatedAt).toLocaleDateString() : 'N/A'}</p>
                  <p><strong>Deleted At:</strong> {item.deletedAt ? new Date(item.deletedAt).toLocaleDateString() : 'N/A'}</p>
                </div>
              </td>
            </tr>
          ))}
